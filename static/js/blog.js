...
document.addEventListener("DOMContentLoaded", function(event) { 
    console.log("This is blog javascript")

    let sc=document.createElement('script')
    sc.setAttribute('src','https://cdn.tiny.cloud/1/cq4rv65u8yi1ljogd1ew5vet7q3ed53jscnioyc2d6ytqtye/tinymce/6/tinymce.min.js');
